...
function pickRegime(data) {
  // jouw API lijkt sometimes regime als object te geven.
  // We renderen altijd label + score netjes.
  const r = data?.regime || {};
  const label =
    typeof r === "string"
      ? r
      : String(r?.label || r?.regime || r?.state || "NEUTRAL");
  const score = n(r?.score, 0); // -100..100 of 0..100, maakt niet uit
  return { label, score };
}
        ...
        <div className="modalBody">
          <div className="sectionGrid">
            ...
            <div className="section">
              ...
              <div className="hint">
                Tip: als er **entry-ready** signals zijn maar geen trades openen, check dan in je backend
                trade trigger (tolerance/spread gate) — dit scherm toont of spread/depth “echt” aanwezig is.
              </div>
            </div>
...
export default function Bull() {
  ...
  // Regime bar: score kan bij jou 0..100 of -100..100 zijn
