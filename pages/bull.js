...
function normalizeFunnel(payload) {
  // verwacht: { funnel: { entry_ready, setup, warmup, radar }, ts, regime }
  if (payload?.funnel && typeof payload.funnel === "object") return payload.funnel;

  // fallback voor sommige debug-achtige payloads
...
export default function Bull() {
  ...
  const [extraBySym, setExtraBySym] = useState({}); // CG cache per symbol
  ...
  function scoreOf(c) {
    ...
    // sommige confidence komt als "158.57" binnen: clamp
  ...
  function openModal(c) {
    ...
    fetchCgDetailsBySymbol(sym)
      .then((extra) => {
        if (extra) {
          setExtraBySym((prev) => ({ ...prev, [sym]: extra }));
        }
      })
          ...
          {arr.map((c) => {
            ...
            return (
              ...
              >
                ...
                <div className="confBarWrap" aria-label="confidence bar">
                  <div
                    className="confBar"
        ...
        <div className="modalCard" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="modalGrid">
            ...
            <section className="modalSection">
              ...
              <div className="hint">
                Tip: als je hier vaak “—” ziet, dan levert je backend deze OB velden niet in de funnel-items
                (of hij gebruikt een andere key dan <code>ob</code>).
              </div>
            </section>
            ...
            <section className="modalSection">
              ...
              <div className="hint">
                Entry-ready ≠ trade open. Trade open gebeurt pas als je trade-engine endpoint/triggers ook lopen.
              </div>
            </section>
          </div>
        </div>
