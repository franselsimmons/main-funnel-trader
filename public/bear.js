    ...
    <button className="coinButton" onClick={() => onOpenModal(c)}>
      <div className="coinCore">
        <div className="coinLeft">
          <div className="coinAvatarText" style={{ background: "rgba(239, 68, 68, 0.2)", borderColor: "var(--red)" }}>
            {avatarLetters}
          </div>
        ...
        <div className="coinMarket">
          ...
          <div className="coinChange" style={{ color: "var(--red)" }}>
            Score: {c.moveScore || "0"}
          </div>
        </div>
      </div>
...
export default function Bear() {
  ...
  const funnel = data?.funnel?.bear || {};

  return (
    <div className="pageShell">
      <header className="topbar">
        <div className="brandBlock">
          <div className="brandTitle" style={{ color: "var(--red)" }}>🔴 BEAR FUNNEL</div>
        ...
        <nav className="navRow">
          ...
          <Link href="/bear" className="navBtn active" style={{ background: "var(--red)", color: "#fff" }}>Bear</Link>
          ...
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <div className="modalTop">
              <div>
                ...
                <div className="modalSubtitle">Short Analyse</div>
              </div>
