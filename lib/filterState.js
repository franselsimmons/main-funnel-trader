...
const DEFAULT_FILTERS = Object.freeze({
  bull: {
    radar:   { scoreMin: 14, volumeMin: 0.025, tfMin: 0, allowNeutral: true },
    buildup: { scoreMin: 30, volumeMin: 0.040, tfMin: 0, allowNeutral: true },
    almost:  { scoreMin: 46, volumeMin: 0.060, tfMin: 1, allowNeutral: false },
    entry:   { scoreMin: 58, volumeMin: 0.080, tfMin: 2, allowNeutral: false }
  },
  bear: {
    radar:   { scoreMin: 14, volumeMin: 0.025, tfMin: 0, allowNeutral: true },
    buildup: { scoreMin: 30, volumeMin: 0.040, tfMin: 0, allowNeutral: true },
