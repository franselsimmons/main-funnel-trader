...
function formatEntryMessage(t) {
  ...
  return `
🟢 **${toText(t.symbol)} ${direction} (${grade})**📊 RR: **${rr}**🎯 Sniper: **${toText(t.sniperScore)}**🧲 Conf: **${toText(t.confluence)}**📉 RSI: **${toText(t.rsi)}**📍 RSI Zone: **${toText(t.rsiZone)}**📚 OB: **${toText(t.obBias)}**
...
function formatExitMessage(t) {
  ...
  if (isWin) {
    return `
✅ **TP geraakt op ${toText(t.symbol)}**🎯 TP: \`${tp}\`💰 RR: **${rr}**📊 Exit R: **${exitR}**📈 PnL %: **${pnlPct}**
`;
  }

  if (isBreakEven) {
    return `
🟡 **Break-even stop op ${toText(t.symbol)}**🛑 SL: \`${sl}\`📊 Exit R: **${exitR}**📈 PnL %: **${pnlPct}**Reason: **${toText(t.reason)}**
`;
  }

  return `
❌ **SL geraakt op ${toText(t.symbol)}**🛑 SL: \`${sl}\`📊 Exit R: **${exitR}**📈 PnL %: **${pnlPct}**Reason: **${toText(t.reason)}**
`;
}
