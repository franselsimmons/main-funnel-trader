...
const MICRO_ROTATION_USE_CURRENT_WEEK_BOOTSTRAP =
  DISCOVERY_MODE ||
  process.env.TS_MICRO_ROTATION_USE_CURRENT_WEEK_BOOTSTRAP === "true" ||
...
function buildCanonicalRotationDecision({
  ...
  const strictGateDisabled = !MICRO_ROTATION_STRICT_ENTRY_GATE;
  ...
  const reason = allowed
    ...
    : rawReason || "REAL_MICRO_FAMILY_NOT_IN_ACTIVE_ROTATION";
