...
// ================= DYNAMIC RR FLOOR =================
const GRADE_A_MIN_RR_FLOOR = 0.75;
const GRADE_B_MIN_RR_FLOOR = 0.85;
const GRADE_C_MIN_RR_FLOOR = 0.95;
const COUNTERTREND_MIN_RR_FLOOR = 1.15;
const BUILDUP_MIN_RR_FLOOR = 1.0;
...
function getDynamicMinRrFloor({
  ...
  if(
    ...
    floor = Math.min(floor, 0.72);
  }

  return clamp(floor, 0.72, 1.25);
}
