// tradeSystem.js - Aangepaste RSI-filters voor trend-continuation
// - Harde LOWER_2/LOWER_3 / UPPER_2/UPPER_3 eisen verwijderd
// - Nieuwe trendContinuationRSI staat MID/LOWER_1 (long) en MID/UPPER_1 (short) toe bij sterke trend
// - MID-filter alleen blokkeren als geen trendContinuationRSI
...
export async function processTrades(input, options = {}) {
  ...
  for (const originalCoin of candidates) {
    ...
    // ========== 🔥 NIEUWE RSI-LOGICA (trend-continuation) ==========
    // TrendContinuationRSI: bij sterke trend mag MID of LOWER_1/UPPER_1
    ...
    // MID filter: alleen blokkeren als geen trendContinuationRSI
    if (rsiZone === "MID" && !trendContinuationRSI && confluence < 80) {
