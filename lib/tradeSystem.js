...
// ================= EXECUTION QUALITY =================
const MAX_SPREAD_PCT = 0.0030; // 0.30%
const MIN_DEPTH_USD_1P = 150000;
const MIN_RR_FLOOR = 1.0;

// ================= DYNAMIC RR FLOOR =================
const GRADE_A_MIN_RR_FLOOR = 0.85;
const GRADE_B_MIN_RR_FLOOR = 1.0;
const GRADE_C_MIN_RR_FLOOR = 1.15;
const COUNTERTREND_MIN_RR_FLOOR = 1.25;
...
function getDynamicMinRrFloor({
  ...
  // De bodem is opgetrokken naar 0.80 om te voorkomen dat de formule ooit te ver zakt.
  return clamp(floor, 0.80, 1.30);
}
