...
// ================= STRATEGY VERSION =================
// openPositions = 0, dus nieuwe clean sample is veilig
...
// ================= RR GATES =================
// A_ENTRY_MIN_RR is PRE-TP gate.
// A_FINAL_MIN_RR is POST-TP gate.
// Niet meer door elkaar halen.
...
// ================= MID RSI =================
// Hou deze streng. Niet verlagen op basis van WAIT logs.
const MID_RSI_MIN_CONFLUENCE = 82;

// ================= DEPTH =================
// 40.250 blokkeert net te veel top A candidates zoals IRYS.
// 35k is nog steeds geen rommel.
...
// ================= NEUTRAL OB =================
// Streng houden. Neutral OB was vaak loser-profiel.
...
// ================= BTC BULLISH SHORT EXCEPTION =================
// Streng houden. ZKP werd terecht geblokt.
