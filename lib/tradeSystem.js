...
// ================= STRATEGY VERSION =================
const STRATEGY_VERSION = "TS_V11_7_ENTRY_CORE_REPAIRED";
...
const GRADE_C_MIN_RR_FLOOR = 1.05;      // PATCHED
...
const BTC_BULLISH_BEAR_EXCEPTION_MAX_CONF = 100;      // PATCHED
...
const NEUTRAL_OB_B_EXCEPTION_MIN_CONFLUENCE = 62;   // PATCHED lager
const NEUTRAL_OB_B_EXCEPTION_MIN_RR = 1.08;
const NEUTRAL_OB_B_EXCEPTION_MIN_SNIPER = 56;       // PATCHED lager
const NEUTRAL_OB_B_EXCEPTION_MIN_SCORE = 70;        // PATCHED lager
const SHADOW_DUPLICATE_COOLDOWN_MS = 30 * 60 * 1000;

// PATCHED: nieuwe constanten voor data fetching en fallback
...
function buildCommonPayload(c, flow, sniper, funding, ob) {
  return {
    ...
    confluenceSource: c._debugConfluenceSource || null,   // PATCHED

    rawSniperScore: c._debugRawSniperScore ?? null,
    fallbackSniperScore: c._debugFallbackSniperScore ?? null,
    sniperBlendUsed: Boolean(c._debugSniperBlendUsed),   // PATCHED
...
function getRsiEdgeMeta({ isBull, rsiSignal, rsiZone }) {
  ...
  let rrDiscount = 0;
  let sniperDiscount = 0; // wordt later gezet, maar we houden variabele
