// tradeSystem.js - Definitieve versie met alle fixes
// - smoothing 14 (rsiEngine)
// - vaste RSI zones 40/33/26 en 60/67/74
// - BTC neutral filter: moveScore < 70 (was 80)
// - MID filter na confluence
// - earlyRSI drempel 75 (i.p.v. 80)
// - sniper?.score veilig
// - minimale candle lengte aangepast naar 80 in rsiEngine
...
export async function processTrades(input, options = {}) {
  ...
  for (const originalCoin of candidates) {
    ...
    // ✅ VERZACHT: neutral van 80 naar 70
    ...
    // ✅ MID filter: nu na confluence, alleen blokkeren bij lage confluence
