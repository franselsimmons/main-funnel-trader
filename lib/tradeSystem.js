// tradeSystem.js - Definitief met versoepelde thresholds
// Fixes:
// 1. sniperOK >= 55 (was 71)
// 2. bEntry: sniperScore >= 50, confluence >= 60 (was 62/66)
// 3. eliteEntry: sniperScore >= 60, confluence >= 70, rr >= 1.1 (was 70/79/1.2)
// 4. Fake breakout: alleen blokkeren als !fake && flow !== "TREND"
// 5. trendContinuationRSI: confluence >= 60, rr >= 1.0 (was 70/1.1)
// 6. Longs in UPPER zones worden geblokt (domme trades voorkomen)
// 7. GRADE_B/C min RR floors: 1.00 en 1.05 (was 1.10/1.20)
// 8. Confluence minimale check: 55 (was dynamisch)
...
const GRADE_B_MIN_RR_FLOOR = 1.00;   // 🔻 verlaagd
const GRADE_C_MIN_RR_FLOOR = 1.05;   // 🔻 verlaagd
...
export async function processTrades(input, options = {}) {
  ...
  for (const originalCoin of candidates) {
    ...
    // ❗ Nieuwe regel: long in UPPER zones blokkeren
    ...
    // 🔻 trendContinuationRSI versoepeld: confluence >= 60, rr >= 1.0
    ...
    // Extra check: LOWER_2 maar nog niet genoeg daling
    ...
    // MID filter: alleen blokkeren als geen trendContinuationRSI en confluence < 70
    ...
    // 🔥 FAKE BREAKOUT: alleen blokkeren als geen fake breakout EN geen TREND flow
    ...
    const sniperOK = sniperScore >= 55;   // 🔻 verlaagd
    ...
    // 🔻 Vaste minimum confluence check (was dynamisch)
