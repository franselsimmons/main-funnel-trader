  ...
  try {
    ...
    console.log("TRADE SYSTEM DURABLE SAVE SPLIT:", JSON.stringify({
      ...
      rows: {
        ...
        microDailyFamilies: Object.keys(auditState.microLearning?.daily?.families || {}).length,
        microWeekFamilies: Object.keys(auditState.microLearning?.week?.families || {}).length,
