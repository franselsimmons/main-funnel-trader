...
const MIN_DEPTH_USD_1P = 250000; // Verhoogd naar 250k voor absolute top liquiditeit
const MIN_RR_FLOOR = 1.0; // Terug naar 1.0: Realistische targets die écht gehaald worden

// ================= DYNAMIC RR FLOOR =================
const GRADE_A_MIN_RR_FLOOR = 1.0;
const GRADE_B_MIN_RR_FLOOR = 1.05;
const GRADE_C_MIN_RR_FLOOR = 1.15;
const COUNTERTREND_MIN_RR_FLOOR = 1.50; // Countertrend blokkeren we later sowieso, maar voor de zekerheid max risk.
const BUILDUP_MIN_RR_FLOOR = 1.1;

// ================= NEUTRAL OB TUNING =================
const NEUTRAL_OB_ENTRY_A_MIN_CONF = 82;
const NEUTRAL_OB_ENTRY_A_MIN_SNIPER = 80;
const NEUTRAL_OB_ENTRY_A_MIN_RR = 1.05;
...
function getDynamicMinRrFloor({
  ...
  if(
    ...
    floor = Math.min(floor, 0.95); // Mag net iets onder de 1.0 duiken voor absolute super trades
  }
