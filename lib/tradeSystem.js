...
export async function processTrades(input, options = {}) {
  ...
  // 🔥 Accepteer zowel scan-object als directe array candidates
  let candidatesRaw = [];
  let scanRegime = null;
  let scanBtc = null;
  ...
  // 🔥 Sorteren + limiet (max 8 coins) – alleen als er niet elders al beperkt is
  // We doen dit nog steeds om veilig te zijn, maar de smart selector heeft zijn eigen limiet (12)
