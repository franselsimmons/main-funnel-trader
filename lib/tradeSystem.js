...
const STRATEGY_VERSION = "TS_V11_2_CLEAN_EXEC_AUDIT";
...
const MAX_FEATURE_STORE_ROWS = 10000;
const MAX_SHADOW_OUTCOME_ROWS = 5000;
...
function serializeRuntimeState() {
  ...
  return {
    ...
    audit: {
      ...
      featureStore: auditState.featureStore || [],
      shadowOutcomes: auditState.shadowOutcomes || []
    }
  };
}
...
// PATCH: aangescherpte isShadowEligible
...
// Doel: één harde conclusie loggen:
// "Voor hoogste winrate + PnL-combinatie: zet filters zo."
// Belangrijk: dit past géén live constants aan.
