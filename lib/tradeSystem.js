...
// Bullish MID trend probe defaults
const BULLISH_MID_TREND_PROBE_MIN_CONFLUENCE = 86;
const BULLISH_MID_TREND_PROBE_MIN_SNIPER = 82;
const BULLISH_MID_TREND_PROBE_MIN_RR = 1.45;
const BULLISH_MID_TREND_PROBE_MAX_SPREAD_PCT = 0.0008;
const BULLISH_MID_TREND_PROBE_MIN_DEPTH_USD_1P = 120_000;
const BULLISH_MID_TREND_PROBE_REQUIRE_BTC_BULLISH = true;
const BULLISH_MID_TREND_PROBE_MIN_1H_MOVE_PCT = 0.15;
const BULLISH_MID_TREND_PROBE_MIN_24H_MOVE_PCT = 1.25;
const BULLISH_MID_TREND_PROBE_MIN_PULLBACK_FROM_HIGH_PCT = 0.003;

// RSI continuation / exhaustion guards
...
const MIN_PRE_TP_GEOMETRY_RR = 1.18;
...
const A_PRE_TP_MIN_BASE_RR = 1.05;
const GOD_PRE_TP_MIN_BASE_RR = 1.10;
const B_PRE_TP_MIN_BASE_RR = 1.15;
...
// ================= MAX DEEP CANDIDATES =================
const MAX_DEEP_CANDIDATES = 30; // was 80 -> 30
...
export async function processTrades(input, options = {}) {
  ...
  const payload = buildWait(
      ...
      requiredRR
        ...
        // ================= PATCH 2: use getFinalRequiredRrFloor =================
