...
export async function processTrades(coins, btc = null, mode = "auto", scannerRegime = null, options = {}) {
  ...
  for (const originalCoin of candidates) {
    ...
    // 🔥 Elite entry: institutionele sniper score >= 80 (of 75 voor meer trades)
    ...
    if (flow.type === "NEUTRAL" && confluence < 58) { actions.push(buildWait(c, "NO_FLOW", flow, sniper, confluence, rr, funding, ob, riskBase, setupGrade, null, null)); continue; }
