...
const A_ENTRY_MIN_RR = 1.00;          // was 1.05
const B_ENTRY_MIN_RR = 0.95;          // was 1.00
const GOD_ENTRY_MIN_RR = 1.25;

const A_MIN_SNIPER = 44;              // was 48
const A_MIN_CONFLUENCE = 56;          // was 60
const B_MIN_SNIPER = 36;              // was 40
const B_MIN_CONFLUENCE = 52;          // was 58
...
const A_FINAL_MIN_RR = 1.05;          // was 1.10
...
const A_MIN_DEPTH_USD_1P = 25_000;     // was 40_250
const BULL_TREND_MIN_DEPTH_USD_1P = 35_000; // was 49_000
...
const NEUTRAL_OB_A_EXCEPTION_MIN_CONFLUENCE = 64;   // was 74
const NEUTRAL_OB_A_EXCEPTION_MIN_RR = 1.15;
const NEUTRAL_OB_A_EXCEPTION_MIN_SNIPER = 68;
const NEUTRAL_OB_B_EXCEPTION_MIN_CONFLUENCE = 66;   // was 76
...
function buildCurrentTsMasterPreset() {
  return {
    ...
    NEUTRAL_OB_A_EXCEPTION_MIN_CONFLUENCE: 64,
    NEUTRAL_OB_A_EXCEPTION_MIN_RR: 1.15,
    NEUTRAL_OB_A_EXCEPTION_MIN_SNIPER: 68,

    NEUTRAL_OB_B_EXCEPTION_MIN_CONFLUENCE: 66,
...
// ================= FINALIZE RESULT (PATCHED WITH WAIT REASON LOGGING) =================
...
// ================= MAX DEEP CANDIDATES (DIAGNOSTIC: INCREASED TO 80) =================
const MAX_DEEP_CANDIDATES = 80;   // tijdelijk verhoogd voor diagnose
