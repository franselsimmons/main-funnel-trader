...
export async function processTrades(
  ...
  for(const originalCoin of candidates){
    ...
    if(ob.bias === "NEUTRAL") minConf += 5;
    if(flow.type === "BUILDING") minConf += 5;
    if(c.tfStrength < 2) minConf += 3;
    if(vol === "HIGH") minConf += 3;
