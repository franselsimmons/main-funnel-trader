...
const ANALYZER_WEBHOOK_SECRET = process.env.ANALYZER_WEBHOOK_SECRET || "090117";

const ANALYZER_WEBHOOK_URL =
  process.env.ANALYZER_WEBHOOK_URL ||
  `https://crypto-voorspeller.vercel.app/api/webhooks/tradesystem?secret=${ANALYZER_WEBHOOK_SECRET}`;
