...
// - Open posities blijven altijd in tracking voor TP/SL
// - Position management vóór alle nieuwe-entry guards
// - Confluence vóór sniper
// - Liquidation price meegegeven
// - BTC / regime uit options
// - Scanner ENTRY = kandidaat, geen echte entry
// - Orderbook memory gebruikt raw + analyzed orderbook
  ...
  const fetchCoinData = async c => {
    ...
    try {
      ...
      if (raw) {
        ...
        // Belangrijk: raw + analyzed meegeven.
