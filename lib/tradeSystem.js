...
// PATCH 7: recordScanObservation – alleen observation tellen, geen shadow outcomes
...
// ================= VERVANGENDE buildCanonicalRotationDecision =================
...
// ================= VERVANGENDE microLearningHasAnyFamilies =================
...
function recordMicroOutcome(row, source = "UNKNOWN") {
  ...
  try {
    ...
    for (const familyId of ids) {
      ...
      // PATCH 8: increase seen for real outcomes as well
      stats.seen++;
      stats.completed++;
      stats.totalR += hasExitR ? exitR : 0;
