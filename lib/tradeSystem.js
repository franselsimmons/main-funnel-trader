...
export async function processTrades(coins){
  ...
  for(const originalCoin of coins){
    ...
    // ================= FINAL RISK =================
    // RR komt nu uit dezelfde SL/TP-structuur als UI + Discord.
    // Als riskManager extra parameters nog niet gebruikt, breekt dit niet.
    ...
    // Geen vaste RR-filter meer.
    // Orderboek + liquidatie + confluence bepalen de kwaliteit.
