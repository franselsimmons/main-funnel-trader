...
function normalizeDiscordResult(result) {
  // Runner notifier returned niks bij succes.
  ...
  // Onbekend object niet als failure behandelen.
  return {
    ok: true,
    mode: "UNKNOWN_OK",
    result
      ...
      try {
        ...
        if (notify && !notifyState.get(key)) {
          const discordOk = await notifyEntrySafe({
            ...
            setupClass,
            entryType: reasonEntry,
            runnerEntryType: reasonEntry,
