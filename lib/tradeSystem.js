...
const STRATEGY_VERSION = "TS_V11_A_ONLY_SHORT_RSI_FIX_R_AUDIT_RESET";
...
const MID_BULL_MAX_SPREAD_PCT = 0.00125;
...
const SHORT_BLOCKED_RSI_ZONES = ["LOWER_1", "LOWER_2", "LOWER_3"];
...
export async function processTrades(input, options = {}) {
  ...
  try {
    ...
    for (const originalCoin of candidates) {
      ...
      if (isBull && rsiZone === "MID" && spread > MID_BULL_MAX_SPREAD_PCT) {
