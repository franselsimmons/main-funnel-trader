...
// Aangepast: smoothing 14, vaste zones (10/17/24), min candles = 80
...
export function getAdvancedRSIContext(candles){
  // ✅ Minimale lengte verlaagd naar 80 (was 120, past bij fetch limit 100)
  ...
  // Stress (optioneel, blijft voor compatibiliteit)
  const returns = [];
  for(let i = 1; i < closes.length; i++){
