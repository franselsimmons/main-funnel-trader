...
// Aangepast: vaste zones i.p.v. dynamische compressie
...
export function getAdvancedRSIContext(candles){
  ...
  // Optioneel: stress blijft beschikbaar maar wordt niet gebruikt voor zones
  // (kan later eventueel voor andere doeleinden dienen)
  const returns = [];
  for(let i = 1; i < closes.length; i++){
