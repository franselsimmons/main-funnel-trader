...
// Risk contribution = fraction of equity lost if a virtual SHORT position hits
// initial SL.
// Required SHORT risk geometry: tp < entry < sl.
// No real orders. No LONG sizing. Exact 75-child trueMicroFamilyId is the
// selectable identity.
...
normalized.includes('TRADESIDE_SHORT')) return TARGET_TRADE_SIDE;
if (normalized.includes('TRADE_SIDE_LONG') ||
normalized.includes('TRADESIDE_LONG')) return OPPOSITE_TRADE_SIDE;
...
haystack.includes('TRADESIDE=LONG')) return OPPOSITE_TRADE_SIDE;
