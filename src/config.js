...
const TEMPORAL_HOURLY_PROFILE_VERSION = 'SHORT_TEMPORAL_DAY_HOUR_PROFILE_V2';
const TEMPORAL_MARKET_WEATHER_PROFILE_VERSION =
...
const TEMPORAL_STATS_ENABLED = bool(
env.SHORT_TEMPORAL_STATS_ENABLED ?? env.TEMPORAL_STATS_ENABLED,
true
);
const RAW_TEMPORAL_POLICY_MODE = str(
env.SHORT_TEMPORAL_POLICY_MODE ?? env.TEMPORAL_POLICY_MODE,
'OBSERVE'
).toUpperCase();
const TEMPORAL_POLICY_MODE = ['OFF', 'OBSERVE', 'ENFORCE'].includes(
RAW_TEMPORAL_POLICY_MODE
) ? RAW_TEMPORAL_POLICY_MODE : 'OBSERVE';
...
statsEnabled: TEMPORAL_STATS_ENABLED,
temporalStatsEnabled: TEMPORAL_STATS_ENABLED,
policyMode: TEMPORAL_POLICY_MODE,
temporalPolicyMode: TEMPORAL_POLICY_MODE,
effectiveTemporalPolicyMode: TEMPORAL_POLICY_MODE,
...
sessionVirtualEntryAllowed: true,
sessionDiscordEntryAllowed: true,
sessionPolicyObservedOnly: TEMPORAL_POLICY_MODE === 'OBSERVE',
...
measurementFixVersion: MEASUREMENT_FIX_VERSION,
outcomeMeasurementGateMode: OUTCOME_MEASUREMENT_GATE_MODE,
blockNewWeekendEntries: false,
weekendEntryPolicyDeferredToActiveGeneration: true,
...
learningConfirmText: str(env.SHORT_RESET_LEARNING_CONFIRM_TEXT,
'RESET_LEARNING_SHORT'),
rotationConfirmText: str(env.SHORT_RESET_ROTATION_CONFIRM_TEXT,
'RESET_ROTATION_SHORT'),
longRootTouched: false,
...shortIdentityFlags
});
...
'SHORT_FIXED_TAXONOMY_75_VIRTUAL_NET_V1'),
root: rootConfig,
direction: directionConfig,
app: appConfig,
redis: redisConfig,
