...
const bitgetConfig = Object.freeze({
  ...
  retryDelayMs: positiveInt(env.BITGET_RETRY_DELAY_MS, 250, 0, 10000),
...
const scannerConfig = Object.freeze({
  ...
  scannerMicroFamilyPrefix: 'MICRO_SHORT_SCANNER_',
...
const tradeConfig = () => Object.freeze({
  ...
  positionTimeStopMin: positiveInt(env.TRADE_POSITION_TIME_STOP_MIN, 720, 5, 7 * 24 * 60),
...
const analyzeConfig = () => Object.freeze({
  ...
  coarseMicroFamilyIdsAlias: false,
  ...
  shadowDedupTtlSec: positiveInt(env.ANALYZE_SHADOW_DEDUPE_TTL_SEC, 3 * 3600, 60, 14 * 24 * 3600),
...
const rotationConfig = () => Object.freeze({
  ...
  minPrimaryRowsForPreviousMerge: positiveInt(env.ROTATION_MIN_PRIMARY_ROW_FOR_PREVIOUS_MERGE, 25, 0, 10_000),
...
// ===== SAMENGEVOEGDE CONFIG VOOR MODULES =====
export const CONFIG = {
  short: {
    trade: tradeConfig(),
...
// Bestaande exports (indien nodig)
export {
  tradeConfig,
  analyzeConfig,
  rotationConfig,
