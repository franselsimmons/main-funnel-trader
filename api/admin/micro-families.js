  ...
  try {
    ...
    return res.status(200).json({
      ...
      perf: {
        ...
        path: 'shortOnly75ChildPersistentLearningNetOutcomeObservationFirstAnalyzeTrueMicroOnlyScannerFingerprintMetadataOnlyCurrentFitMarketWeatherAvgCostRFallbackFixV3SelfHeal',
