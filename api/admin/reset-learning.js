...
temporalContextPattern: namespacedShortPattern(
KEYS.short?.analyze?.temporalContextPattern ||
KEYS.analyze?.shortTemporalContextPattern,
'ANALYZE:TEMPORAL:*'
),
...
redis,
SHORT_KEYS.analyze.temporalContextPattern
),
...
res.setHeader('X-Admin-Reset-Learning-Mode', 'short-only-75-child-virtuallearning-v1');
...
note: 'reset-learning wist alleen SHORT leerdata. Handmatige SHORT 75child selectie blijft bewaard.',
...modeFlags()
});
}
