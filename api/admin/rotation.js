...
value.includes('SELL')) return TARGET_TRADE_SIDE;
...
4),
      currentR: risk.shortCurrentR === null ? row.currentR ?? null :
...
weekCompositionDimensions: {
  ...
  marketWeatherKeys: [
    ...
    'SQUEEZE|SHORT', 'SQUEEZE|NEUTRAL', 'SQUEEZE|LONG',
    'UNKNOWN'
  ],
...
buttons: {
     selectExact75Child: true,
        ...
        perf: {
             ...
             source:
'short_manual_selection_only_exact_75_child_true_micro_rotation_dashboard'
        },
...
perf: {
  durationMs: now() - startedAt,
           source:
'activateSelectedShort75ChildTrueMicroFamilies_manual_only_exact_match'
      },
